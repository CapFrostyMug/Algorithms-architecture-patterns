...
/**
 * В данном проекте шаблон Registry реализует класс Registry.
 *
 * Цель применения данного шаблона в проекте – обеспечить глобальный доступ к некоторым данным (например, к данным
 * из конфигурационного файла) из любой точки приложения без использования глобальных переменных.
 */
